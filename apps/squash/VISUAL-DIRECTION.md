...
| 藍衣／黃衣選手 | 八張獨立 sprite sheet，共 192 幀素材，不以 tint 共用人物；反拍另繪、不鏡像正手 |
...
- 角色重畫為藍衣與黃衣兩名獨立選手，共 192 幀後視角素材與眼神演出；兩人各新增 12 幀獨立右手反拍。
...
瀏覽器實際切換到「AI 對戰」、速度 2×，讓比賽自動進行。判分驗收先看到 24 拍連續回合，之後金方因第二次落地取得 1 分並自動接續發球，畫面與 DOM 比分同步顯示 `BLUE AI 0 : 1 GOLD AI`。最終玻璃球版跑到 7 分局面，戰術 feed 實際出現藍、金雙方的「後玻璃解圍」，第二次落地、比分與自動發球皆持續運作；角色驗收室顯示 `192 / 192` 幀素材載入完成，兩個頁面的 console error 都是 0。
